...
import TransparentButton from '../Generics/YellowButton';
            ...
            <div className="container">
                <div className="content">
                    ...
                    <div className="buttons">
                        <YellowButton text="Get Consulting" url="/services/get-consulting"/>
                        <TransparentButton text="Learn More" url="/services/consulting"/>
                    </div>
                </div>
